...
if __name__ == "__main__":
    ...
    # # tgt = "គាត់​បាន​បន្ត​ថា​ “ឥឡូវ​នេះ​យើង​មាន​កណ្តុរ​ដែល​មាន​អាយុ​៤​ខែ​ដែល​មិន​មែន​ជា​អ្នក​ដែល​មាន​ជំងឺ​ទឹក​នោម​ផ្អែម​(Diabetes)​ ដែល​ពួក​គេ​មាន​ជំងឺ​នេះ​មុន​នេះ​”​។"
    # # tgt = "លោក​បាន​សង្កេត​ឃើញ​ថា​គ្មាន​ភាព​ជឿ​ជាក់​ណាស់​ថា​ជំងឺ​ដុំ​ស្ករ​(Diabetes)​អាច​ត្រូវ​បាន​សម្រាប់​ជា​រៀង​រហូត​(Cured)​ ដោយ​សារ​តែ​លទ្ធផល​ទាំង​នេះ​មិន​អាច​អនុវត្ត​បាន​ដល់​អ្នក​ដែល​មាន​ជំងឺ​ដុំ​ស្ករ​ប្រភេទ​ទី​១​(Type 1 Diabetes)​នៅ​ឡើយ​ទេ។"
    ...
    # tgt = "Àwọn Ìjọ tí ń ṣàtẹ́gun àwọn ẹ̀tọ̀ tí ọlọ́dàwọ̀dà (Traditional churches) maa ṣe Ìgbàlà Ìtẹ̀wọ̀yìn (Easter Vigil) ni àwọn alẹ̀ Sátide nigbàgbè Ìgbàdùdù Ìtẹ̀wọ̀yìn (Easter weekend), pẹ̀lú ẹgbẹ́-iṣẹ́wọ̀yìn naa maa ṣe ayẹyin (celebrate) ni àkọ́kọ́lẹ̀dùgbà (at midnight) lati ṣe ayẹyin Ìtẹ̀wọ̀yìn Kristi (Easter)."
