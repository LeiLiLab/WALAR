...
x = [60, 80, 100, 120, 140, 160, 180, 200, 260, 300]
...
y = [23.7, 24.09, 24.41, 24.48, 24.44, 23.94, 23.82, 22.6, 20.99, 20
     .48]
...
# 添加标题和标签
plt.title(f'{eval_type}')
plt.xlabel('Training Step')
plt.ylabel(f'{eval_type} Score')
...
# 显示图形
plt.show()
plt.savefig(f'{eval_type}_val.png')
