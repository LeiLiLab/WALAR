...
def update_samples_with_rewards(rewards_info, samples_list, rwd1=None, rwd2=None):
    ...
    for i, samples in enumerate(samples_list):
        ...
        samples.scores = samples.scores.unsqueeze(0)
...
class SamplesGenerator:
    ...
    def _generate_vllm(self, all_prompts: List[str], all_labels, **kwargs) -> List[Experience]:
        ...
        remote_reward_model2 = kwargs.get('remote_reward_model2', None)
        if remote_reward_model:
            ...
            if remote_reward_model2 is not None:
                ...
                # breakpoint()
                for info1, info2 in zip(rewards_info, rewards_info2):
